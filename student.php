...
<html lang = "eng">
	<head>
		<title>Perpustakaan PSTI A</title>
		<meta charset = "utf-8" />
	...
	<body style = "background-color:#d3d3d3;">
		<nav class = "navbar navbar-default navbar-fixed-top">
			<div class = "container-fluid">
				<div class = "navbar-header">
					<img src = "images/logoicon.png" width = "50px" height = "50px" />
					<h4 class = "navbar-text navbar-right">Perpustakaan PSTI A</h4>
				</div>
			</div>
		</nav>
		<div class = "container-fluid">
			<div class = "col-lg-2 well" style = "margin-top:60px;">
				...
				<ul id = "menu" class = "nav menu">
					...
					<li><a  style = "font-size:18px; border-bottom:1px solid #d3d3d3;" href = ""><i class = "glyphicon glyphicon-cog"></i> Settings</a>
						<ul style = "list-style-type:none;">
							<li><a style = "font-size:15px;" href = "logoiconut.php"><i class = "glyphicon glyphicon-log-out"></i> logoiconut</a></li>
						</ul>
					</li>
				</ul>
			</div>
		...
		<nav class = "navbar navbar-default navbar-fixed-bottom">
			<div class = "container-fluid">
				<label class = "navbar-text pull-right">Perpustakaan PSTI A &copy; Habib Pandya dan Dzikri Rofa</label>
			</div>
		</nav>
	</body>
